        ...
        <nav>
          ...
          <ul className="m-nav">
            <li className="m-nav__item">
              <a href="index.html" onClick={() => {this.toggleNav('index.html')}} className={`a-link a-link--nav ${this.state.currentSite === 'index.html' ? 'a-link--nav--active' : '' }`}>Search Flight</a>
            </li>
            { this.state.isLoggedIn === true ? 
              <li className="m-nav__item">
                <a href="my-account.html" onClick={() => {this.toggleNav('my-account.html')}} className={`a-link a-link--nav ${this.state.currentSite === 'my-account.html' ? 'a-link--nav--active' : '' }`}>My account</a>
              </li>
            : <li className="m-nav__item">
                <a href="create.html" onClick={() => {this.toggleNav('create.html')}} className={`a-link a-link--nav ${this.state.currentSite === 'create.html' ? 'a-link--nav--active' : '' }`}>Create account</a>
              </li> }
            <li className="m-nav__item">
              { this.state.isLoggedIn === true 
            ...
            { this.state.isLoggingIn ? <form className="o-form o-login-form o-form--absolute o-form--top-arrow o-form--sm o-main-nav__login u-grid" method="POST" ref={this.form} onSubmit={this.onFormSubmit}>
              <div className="o-form__content u-pill--top u-pill--bottom">
                ...
                <div className="m-form-group o-form__row">
                  <label htmlFor="input_username" className="a-label m-form-group__label">Password</label>
